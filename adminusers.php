...
$queryy2=mysqli_query($con,$query2);
$num2=mysqli_num_rows($queryy2);
...
<div class="hai">
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    <li><a href="adminvehicle.php">VEHICLES AND SERVICES</a></li>
        ...
        <div>
            ...
            <div>
                ...
                while($res=mysqli_fetch_array($queryy2)){
                
                
                ?>
                <tr  class="active-row">
                    <td><?php echo $res['name'];?></php></td>
                    <td><?php echo $res['vname'];?></php></td>
                    <td><?php echo $res['email'];?></php></td>
                    <td><?php echo $res['regno'];?></php></td>
                    <td><?php echo $res['phone_number'];?></php></td>
                    <td><button type="submit" class="but" name="approve"><a href="deleteowner.php?id=<?php echo $res['email']?>">DELETE CUSTOMER</a></button></td>
                </tr>
               <?php } ?>
                </tbody>
                </table>
