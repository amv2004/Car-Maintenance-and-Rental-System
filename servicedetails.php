...
<?php 
    ...
    $services= mysqli_query($con,$sql2);
  ...
  <div class="cd">
    <div class="main">
      ...
      <div><h1 class="overview">OUR SERVICES OVERVIEW</h1>

    <ul class="de">
    <?php
        while($result= mysqli_fetch_array($services))
        {
            // echo $result['CAR_ID'];
    ...
    <div class="box">
       <div class="imgBx">
            <img src="images/<?php echo $result['s_img']?>">
        </div>
        <div class="content">
            <?php $res=$result['s_id'];?>
            <h1><?php echo $result['s_name']?></h1>
            <h2>Price : <a>₹<?php echo $result['price']?>/-</a></h2>
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a href="booking2.php?id=<?php echo $res;?>">book</a></button>
        </div>
    </div></form></li>
    <?php
        }
