...
if(isset($_POST['regs']))
{
    ...
    $Pass=md5($pass);
    if(empty($name)|| empty($vname)|| empty($email)|| empty($reg)|| empty($ph)|| empty($pass))
    {
        ...
        $sql="insert into owners (NAME,VNAME,EMAIL,REGNO,PHONE_NUMBER,PASSWORD) values('$name','$vname','$email','$reg',$ph,'$Pass')";
...
.invalid:before {
 ...
 <div class="main">
        ...
        <form id="register" action="register2.php" method="POST">    
            ...
            id="name" placeholder="Enter Your Car Model Name" required>
            <br><br>
            ...
            <label>Your Car's Registration Number : </label>
            <br>
            <input type="text" name="reg"
            id="name" placeholder="Enter Your Car's Registration number" required>
            <br><br>
